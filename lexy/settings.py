"""
Django settings for lexy project.
...
SECRET_KEY = 'django-insecure-jc2i4u%68%laq4mykw94-t*b7c^vfi$%mn&egv@(wq@^y(@n$('
...
WSGI_APPLICATION = 'lexy.wsgi.application'
